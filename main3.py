# -*- coding: utf-8 -*-
# ==============================================================================
# 🔥 PROJECT RUST v2.0 - THE BACKTESTING EDITION 🔥
#    The first major upgrade. Now with a Backtesting Module.
    ...
    with Live(Spinner("dots", text="[bold green]पुराने डेटा पर रणनीतियों का परीक्षण किया जा रहा है...[/bold green]"), console=console) as live:
        for name, strategy in strategies.items():
            ...
            for i in range(start_index, end_index):
                ...
                total_attempts += 1
                preds = predict_daily(train_df, strategy, ['Open', 'Close'])
                if 'otc' in preds and preds['otc'] and (actual_open in preds['otc'] or actual_close in preds['otc']):
                    hits += 1
            if total_attempts > 0:
...
def display_main_menu():
    os.system('cls' if os.name == 'nt' else 'clear')
    banner = Text("🔥 PROJECT RUST v2.0 - THE BACKTESTING EDITION 🔥", justify="center", style="bold yellow on red")
    console.print(Panel(banner, border_style="red"))
    console.print("\n[bold cyan]नमस्ते भाई, मैं Jarvis का नया अवतार, Phoenix Engine हूँ।[/bold cyan]")
    console.print("[cyan]हमारा पहला अपग्रेड तैयार है।[/cyan]\n")
...
def main():
    while True:
        ...
        run_predictions_for_market(market_name, df_featured)
